...
class VueRecherche extends VueGenerique{
    ...
    public function afficherRecette($tabR){
      ...
      echo'<div width=100% align="center"><button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Selectionner categorie</button>
