        ...
        public   function __construct() {
         ...
         public function afficher_form_Recette($tabIngr){   
            ...
            <div class="form-check form-switch">
               ...
               <div align=right><button type="button" id="supprimerCategories" class="btn btn-outline-danger" align="right" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
